...
$(document).ready(function() {
    ...
    // end
    $('.bl-category .dropdown #dropdownmenu').click(function() {
    ...
    $('#toggle-search-mb').click(function() {
        $('#search-form-mb, #toggle-search-mb').toggleClass('open');
        return false;
    });

    // Handle click on search submit button
    $('#search-form-mb input[type=submit]').click(function() {
        $('#search-form-mb, #toggle-search-mb').toggleClass('open');
        return true;
    });
...
const playerSlides = Array.from(document.querySelectorAll('.js-player')).map(p => new Plyr(p, {
    autoplay: true
}));