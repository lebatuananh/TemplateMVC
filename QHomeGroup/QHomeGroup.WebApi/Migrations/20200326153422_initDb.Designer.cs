...
namespace QHomeGroup.WebApi.Migrations
{
    ...
    [Migration("20200326153422_initDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.ProjectImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.Project", b =>
                {
                    ...
                    b.HasOne("QHomeGroup.Data.Entities.Project.Location", "Location")
                        .WithMany("Projects")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("QHomeGroup.Data.Entities.Project.Service", "Service")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("QHomeGroup.Data.Entities.Project.ProjectImage", b =>
                {
                    b.HasOne("QHomeGroup.Data.Entities.Project.Project", "Project")
